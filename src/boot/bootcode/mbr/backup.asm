...
relocated_org   equ 600h
buildtime_org   equ 100h
...
m1 db    "Invalid partition table",nu
m2 db    "Error loading operating system",nu
m3 db    "Missing operating system",nu

a_LookingForEntryNum db "Looking for partition ", nu
